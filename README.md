This is a use case for the TraceParts API Gateway in the **Php** language. 

You will find everything to use and to understand the Gateway and its different calls. 
